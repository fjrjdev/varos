                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 transition-colors duration-300 ease-in-out">
                        <div className="flex items-center justify-between h-16">
                                ...
                                <div className="hidden md:flex items-baseline space-x-4">
                                    {leftNavigation.map((item) => (
                                        <a
                                            key={item.name}
                                            href={item.href}
                                            className="text-gray-300 hover:text-white px-1 py-2 rounded-md text-sm font-medium flex items-center font-redhat-display"
                                        >
                            ...
                            <div className="-mr-2 flex md:hidden">
                                <Disclosure.Button className="bg-[#131313] p-2 inline-flex items-center justify-center text-gray-400 hover:text-white focus:outline-none transition-transform duration-300 ease-in-out transform  font-redhat-display">
                                        ...
                                        {item.component ? (
                                            ...
                                            <>
                                                {item.name !== 'Produtos' && (
                                                    <a
                                                        href={item.href}
                                                        className="text-gray-300 hover:text-white block px-3 py-2  text-base font-medium border-b font-redhat-display"
                                                    >
                                                        {item.name}
                                                    </a>
                                                )}
